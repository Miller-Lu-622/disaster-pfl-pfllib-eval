#!/bin/bash
#SBATCH --job-name=xbd-dis50
#SBATCH --output=logs/xbd-dis50-%j.out
#SBATCH --error=logs/xbd-dis50-%j.err
...
python scripts/xbd/train_xbd_fedavg_disaster_balanced_50r_record.py
