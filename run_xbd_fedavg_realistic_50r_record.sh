#!/bin/bash
#SBATCH --job-name=xbd-real50
#SBATCH --output=logs/xbd-real50-%j.out
#SBATCH --error=logs/xbd-real50-%j.err
...
python scripts/xbd/train_xbd_fedavg_realistic_50r_record.py
